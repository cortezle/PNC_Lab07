...
public class MainController {
	...
	@RequestMapping(value="/mostrarEstudiante",method=RequestMethod.POST,params="action=buscar")
	public ModelAndView findOne(@RequestParam(value="Codigo") int id) {
		ModelAndView mav = new ModelAndView();
	...
	@RequestMapping(value="/mostrarEstudiante",method=RequestMethod.POST,params="action=borrar")
	public ModelAndView BorrarOne(@RequestParam(value="Codigo") int id) {
		ModelAndView mav = new ModelAndView();
		List<Estudiante> estudiantes=null;
		try {
	...
	@RequestMapping(value="/mostrarEstudiante",method=RequestMethod.POST,params="action=editar")
